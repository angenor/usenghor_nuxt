...
export const historyPageSections: PageSection[] = [
  {
    ...
    editorialKeys: ['historypage.hero.badge', 'historypage.hero.title', 'historypage.hero.subtitle', 'historypage.intro.text'],
    fields: [
      { key: 'historypage.hero.badge', label: 'Badge', description: 'Badge affiché dans le hero (ex: Historique)', type: 'text', editorialKey: 'historypage.hero.badge', editable: true },
      { key: 'historypage.hero.title', label: 'Titre', description: 'Titre principal de la page', type: 'text', editorialKey: 'historypage.hero.title', editable: true },
      { key: 'historypage.hero.subtitle', label: 'Sous-titre', description: 'Description dans le hero', type: 'textarea', editorialKey: 'historypage.hero.subtitle', editable: true },
      { key: 'historypage.intro.text', label: 'Texte d\'introduction', description: 'Paragraphe d\'introduction sous le hero', type: 'textarea', editorialKey: 'historypage.intro.text', editable: true },
    ],
  },
  {
    id: 'historypage-genesis',
    name: 'Section Genèse',
    description: 'Origine et création de l\'université',
    icon: 'seedling',
    color: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
    editorialKeys: ['historypage.genesis.date', 'historypage.genesis.title', 'historypage.genesis.description', 'historypage.genesis.point1', 'historypage.genesis.point2'],
    fields: [
      { key: 'historypage.genesis.date', label: 'Date', description: 'Date de la genèse (ex: Mai 1989 - Dakar)', type: 'text', editorialKey: 'historypage.genesis.date', editable: true },
      { key: 'historypage.genesis.title', label: 'Titre', description: 'Titre de la section genèse', type: 'text', editorialKey: 'historypage.genesis.title', editable: true },
      { key: 'historypage.genesis.description', label: 'Description', description: 'Description détaillée de la genèse', type: 'html', editorialKey: 'historypage.genesis.description', editable: true },
      { key: 'historypage.genesis.point1', label: 'Point clé 1', description: 'Premier point clé', type: 'text', editorialKey: 'historypage.genesis.point1', editable: true },
      { key: 'historypage.genesis.point2', label: 'Point clé 2', description: 'Deuxième point clé', type: 'text', editorialKey: 'historypage.genesis.point2', editable: true },
    ],
  },
  {
    id: 'historypage-founders',
    name: 'Section Fondateurs',
    description: 'Les pères fondateurs de l\'université',
    icon: 'users',
    color: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300',
    editorialKeys: ['historypage.founders.title', 'historypage.founders.subtitle', 'historypage.founders.senghor.role', 'historypage.founders.druon.role', 'historypage.founders.boutros.role', 'historypage.founders.dupuy.role'],
    fields: [
      { key: 'historypage.founders.title', label: 'Titre', description: 'Titre de la section fondateurs', type: 'text', editorialKey: 'historypage.founders.title', editable: true },
      { key: 'historypage.founders.subtitle', label: 'Sous-titre', description: 'Sous-titre de la section', type: 'text', editorialKey: 'historypage.founders.subtitle', editable: true },
      { key: 'historypage.founders.senghor.role', label: 'Rôle Senghor', description: 'Description du rôle de Léopold Sédar Senghor', type: 'text', editorialKey: 'historypage.founders.senghor.role', editable: true },
      { key: 'historypage.founders.druon.role', label: 'Rôle Druon', description: 'Description du rôle de Maurice Druon', type: 'text', editorialKey: 'historypage.founders.druon.role', editable: true },
      { key: 'historypage.founders.boutros.role', label: 'Rôle Boutros-Ghali', description: 'Description du rôle de Boutros Boutros-Ghali', type: 'text', editorialKey: 'historypage.founders.boutros.role', editable: true },
      { key: 'historypage.founders.dupuy.role', label: 'Rôle Dupuy', description: 'Description du rôle de René-Jean Dupuy', type: 'text', editorialKey: 'historypage.founders.dupuy.role', editable: true },
    ],
  },
  {
    id: 'historypage-usenghor',
    name: 'Section USenghor',
    description: 'L\'université Senghor et ses jalons',
    icon: 'university',
    color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300',
    editorialKeys: ['historypage.usenghor.since', 'historypage.usenghor.title', 'historypage.usenghor.description', 'historypage.usenghor.milestone1.title', 'historypage.usenghor.milestone1.desc', 'historypage.usenghor.milestone2.title', 'historypage.usenghor.milestone2.desc'],
    fields: [
      { key: 'historypage.usenghor.since', label: 'Depuis', description: 'Date de création (ex: Depuis octobre 1990)', type: 'text', editorialKey: 'historypage.usenghor.since', editable: true },
      { key: 'historypage.usenghor.title', label: 'Titre', description: 'Titre de la section USenghor', type: 'text', editorialKey: 'historypage.usenghor.title', editable: true },
      { key: 'historypage.usenghor.description', label: 'Description', description: 'Description de l\'université', type: 'html', editorialKey: 'historypage.usenghor.description', editable: true },
      { key: 'historypage.usenghor.milestone1.title', label: 'Jalon 1 - Titre', description: 'Titre du premier jalon', type: 'text', editorialKey: 'historypage.usenghor.milestone1.title', editable: true },
      { key: 'historypage.usenghor.milestone1.desc', label: 'Jalon 1 - Description', description: 'Description du premier jalon', type: 'text', editorialKey: 'historypage.usenghor.milestone1.desc', editable: true },
      { key: 'historypage.usenghor.milestone2.title', label: 'Jalon 2 - Titre', description: 'Titre du deuxième jalon', type: 'text', editorialKey: 'historypage.usenghor.milestone2.title', editable: true },
      { key: 'historypage.usenghor.milestone2.desc', label: 'Jalon 2 - Description', description: 'Description du deuxième jalon', type: 'text', editorialKey: 'historypage.usenghor.milestone2.desc', editable: true },
    ],
  },
  {
    ...
    icon: 'calendar',
    color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300',
    editorialKeys: ['historypage.timeline.1989.title', 'historypage.timeline.1989.description', 'historypage.timeline.1989.rector', 'historypage.timeline.1989.president'],
    fields: [
      { key: 'historypage.timeline.1989.title', label: 'Titre', description: 'Titre de l\'événement 1989', type: 'text', editorialKey: 'historypage.timeline.1989.title', editable: true },
      { key: 'historypage.timeline.1989.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.1989.description', editable: true },
      { key: 'historypage.timeline.1989.rector', label: 'Recteur', description: 'Nom du recteur', type: 'text', editorialKey: 'historypage.timeline.1989.rector', editable: true },
      { key: 'historypage.timeline.1989.president', label: 'Président', description: 'Nom du président', type: 'text', editorialKey: 'historypage.timeline.1989.president', editable: true },
    ],
  },
  {
    id: 'historypage-timeline-1991',
    name: 'Timeline - 1991',
    description: 'Nouveau recteur',
    icon: 'calendar',
    color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300',
    editorialKeys: ['historypage.timeline.1991.title', 'historypage.timeline.1991.description', 'historypage.timeline.1991.rector', 'historypage.timeline.1991.president'],
    fields: [
      { key: 'historypage.timeline.1991.title', label: 'Titre', description: 'Titre de l\'événement 1991', type: 'text', editorialKey: 'historypage.timeline.1991.title', editable: true },
      { key: 'historypage.timeline.1991.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.1991.description', editable: true },
      { key: 'historypage.timeline.1991.rector', label: 'Recteur', description: 'Nom du recteur', type: 'text', editorialKey: 'historypage.timeline.1991.rector', editable: true },
      { key: 'historypage.timeline.1991.president', label: 'Président', description: 'Nom du président', type: 'text', editorialKey: 'historypage.timeline.1991.president', editable: true },
    ],
  },
  {
    id: 'historypage-timeline-1993',
    name: 'Timeline - 1993',
    description: 'Phase de développement',
    icon: 'calendar',
    color: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
    editorialKeys: ['historypage.timeline.1993.title', 'historypage.timeline.1993.description', 'historypage.timeline.1993.rector', 'historypage.timeline.1993.president'],
    fields: [
      { key: 'historypage.timeline.1993.title', label: 'Titre', description: 'Titre de l\'événement 1993', type: 'text', editorialKey: 'historypage.timeline.1993.title', editable: true },
      { key: 'historypage.timeline.1993.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.1993.description', editable: true },
      { key: 'historypage.timeline.1993.rector', label: 'Recteur', description: 'Nom du recteur', type: 'text', editorialKey: 'historypage.timeline.1993.rector', editable: true },
      { key: 'historypage.timeline.1993.president', label: 'Président', description: 'Nom du président', type: 'text', editorialKey: 'historypage.timeline.1993.president', editable: true },
    ],
  },
  {
    ...
    icon: 'calendar',
    color: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
    editorialKeys: ['historypage.timeline.2002.title', 'historypage.timeline.2002.description', 'historypage.timeline.2002.rector', 'historypage.timeline.2002.president'],
    fields: [
      { key: 'historypage.timeline.2002.title', label: 'Titre', description: 'Titre de l\'événement 2002', type: 'text', editorialKey: 'historypage.timeline.2002.title', editable: true },
      { key: 'historypage.timeline.2002.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.2002.description', editable: true },
      { key: 'historypage.timeline.2002.rector', label: 'Recteur', description: 'Nom du recteur', type: 'text', editorialKey: 'historypage.timeline.2002.rector', editable: true },
      { key: 'historypage.timeline.2002.president', label: 'Président', description: 'Nom du président', type: 'text', editorialKey: 'historypage.timeline.2002.president', editable: true },
    ],
  },
  {
    id: 'historypage-timeline-2004',
    name: 'Timeline - 2004',
    description: 'Phase de rayonnement',
    icon: 'calendar',
    color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300',
    editorialKeys: ['historypage.timeline.2004.title', 'historypage.timeline.2004.description', 'historypage.timeline.2004.rector', 'historypage.timeline.2004.president'],
    fields: [
      { key: 'historypage.timeline.2004.title', label: 'Titre', description: 'Titre de l\'événement 2004', type: 'text', editorialKey: 'historypage.timeline.2004.title', editable: true },
      { key: 'historypage.timeline.2004.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.2004.description', editable: true },
      { key: 'historypage.timeline.2004.rector', label: 'Recteur', description: 'Nom du recteur', type: 'text', editorialKey: 'historypage.timeline.2004.rector', editable: true },
      { key: 'historypage.timeline.2004.president', label: 'Président', description: 'Nom du président', type: 'text', editorialKey: 'historypage.timeline.2004.president', editable: true },
    ],
  },
  {
    id: 'historypage-timeline-2009',
    name: 'Timeline - 2009',
    description: 'Continuité et modernisation',
    icon: 'calendar',
    color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300',
    editorialKeys: ['historypage.timeline.2009.title', 'historypage.timeline.2009.description', 'historypage.timeline.2009.rector', 'historypage.timeline.2009.president'],
    fields: [
      { key: 'historypage.timeline.2009.title', label: 'Titre', description: 'Titre de l\'événement 2009', type: 'text', editorialKey: 'historypage.timeline.2009.title', editable: true },
      { key: 'historypage.timeline.2009.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.2009.description', editable: true },
      { key: 'historypage.timeline.2009.rector', label: 'Recteur', description: 'Nom du recteur', type: 'text', editorialKey: 'historypage.timeline.2009.rector', editable: true },
      { key: 'historypage.timeline.2009.president', label: 'Président', description: 'Nom du président', type: 'text', editorialKey: 'historypage.timeline.2009.president', editable: true },
    ],
  },
  {
    ...
    editorialKeys: ['historypage.timeline.2016.title', 'historypage.timeline.2016.description', 'historypage.timeline.2016.rector', 'historypage.timeline.2016.president'],
    fields: [
      { key: 'historypage.timeline.2016.title', label: 'Titre', description: 'Titre de l\'événement 2016', type: 'text', editorialKey: 'historypage.timeline.2016.title', editable: true },
      { key: 'historypage.timeline.2016.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.2016.description', editable: true },
      { key: 'historypage.timeline.2016.rector', label: 'Recteur', description: 'Nom du recteur', type: 'text', editorialKey: 'historypage.timeline.2016.rector', editable: true },
      { key: 'historypage.timeline.2016.president', label: 'Président', description: 'Nom du président', type: 'text', editorialKey: 'historypage.timeline.2016.president', editable: true },
    ],
  },
  {
    ...
    icon: 'calendar',
    color: 'bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300',
    editorialKeys: ['historypage.timeline.2020.title', 'historypage.timeline.2020.description'],
    fields: [
      { key: 'historypage.timeline.2020.title', label: 'Titre', description: 'Titre de l\'événement 2020', type: 'text', editorialKey: 'historypage.timeline.2020.title', editable: true },
      { key: 'historypage.timeline.2020.description', label: 'Description', description: 'Description de l\'événement', type: 'textarea', editorialKey: 'historypage.timeline.2020.description', editable: true },
    ],
  },
  {
    id: 'historypage-leadership',
    name: 'Section Direction actuelle',
    description: 'Recteur et président actuels',
    icon: 'user-tie',
    color: 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300',
    editorialKeys: ['historypage.leadership.title', 'historypage.leadership.rector.name', 'historypage.leadership.rector.title', 'historypage.leadership.rector.since', 'historypage.leadership.president.name', 'historypage.leadership.president.title'],
    fields: [
      { key: 'historypage.leadership.title', label: 'Titre', description: 'Titre de la section direction', type: 'text', editorialKey: 'historypage.leadership.title', editable: true },
      { key: 'historypage.leadership.rector.name', label: 'Nom du Recteur', description: 'Nom complet du recteur', type: 'text', editorialKey: 'historypage.leadership.rector.name', editable: true },
      { key: 'historypage.leadership.rector.title', label: 'Titre du Recteur', description: 'Titre/fonction', type: 'text', editorialKey: 'historypage.leadership.rector.title', editable: true },
      { key: 'historypage.leadership.rector.since', label: 'Depuis', description: 'Date de prise de fonction', type: 'text', editorialKey: 'historypage.leadership.rector.since', editable: true },
      { key: 'historypage.leadership.president.name', label: 'Nom du Président', description: 'Nom complet du président', type: 'text', editorialKey: 'historypage.leadership.president.name', editable: true },
      { key: 'historypage.leadership.president.title', label: 'Titre du Président', description: 'Titre/fonction', type: 'text', editorialKey: 'historypage.leadership.president.title', editable: true },
    ],
  },
  {
    id: 'historypage-legacy',
    name: 'Section Héritage',
    description: 'Notre mission qui perdure',
    icon: 'crown',
    color: 'bg-brand-red-100 text-brand-red-800 dark:bg-brand-red-900/30 dark:text-brand-red-300',
    editorialKeys: ['historypage.legacy.badge', 'historypage.legacy.title', 'historypage.legacy.description', 'historypage.legacy.tags'],
    fields: [
      { key: 'historypage.legacy.badge', label: 'Badge', description: 'Badge de la section (ex: Notre héritage)', type: 'text', editorialKey: 'historypage.legacy.badge', editable: true },
      { key: 'historypage.legacy.title', label: 'Titre', description: 'Titre de la section héritage', type: 'text', editorialKey: 'historypage.legacy.title', editable: true },
      { key: 'historypage.legacy.description', label: 'Description', description: 'Description de l\'héritage', type: 'html', editorialKey: 'historypage.legacy.description', editable: true },
      { key: 'historypage.legacy.tags', label: 'Tags', description: 'Tags séparés par des virgules', type: 'list', editorialKey: 'historypage.legacy.tags', editable: true },
    ],
  },
]
