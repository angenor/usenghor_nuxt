  ...
  <div v-if="hasContent" class="fixed bottom-6 right-6 z-50">
    ...
    >
      <button
        v-if="!isOpen"
        @click="isOpen = true"
        class="group relative flex items-center gap-3 bg-gradient-to-r from-brand-blue-500 to-brand-blue-600 hover:from-brand-blue-600 hover:to-brand-blue-700 text-white px-5 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
      >
    ...
    >
      ...
      >
        <!-- En-tête -->
        <div class="bg-gradient-to-r from-brand-blue-500 to-brand-blue-600 px-4 py-3 flex items-center justify-between">
        ...
        <div v-if="!isMinimized" class="flex border-b border-gray-100 dark:border-gray-700">
          <button
            ...
            :class="activeTab === 'events'
              ? 'text-brand-blue-600 dark:text-brand-blue-400 border-b-2 border-brand-blue-500'
              : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'"
          >
            <font-awesome-icon icon="fa-solid fa-calendar-days" class="w-4 h-4" />
            {{ t('widget.featured.events') }}
            <span class="bg-brand-blue-100 dark:bg-brand-blue-900/30 text-brand-blue-600 dark:text-brand-blue-400 text-xs px-1.5 py-0.5 rounded-full">
          ...
          <div class="divide-y divide-gray-100 dark:divide-gray-700">
            ...
            >
              ...
              <div class="flex-shrink-0 w-14 text-center">
                <div class="bg-brand-red-100 dark:bg-brand-red-900/30 rounded-lg p-2">
                  <div class="text-xs text-brand-red-600 dark:text-brand-red-400 font-medium uppercase">
                    {{ formatDate(event.date).split(' ')[1] }}
                  </div>
                  <div class="text-lg font-bold text-brand-red-700 dark:text-brand-red-300">
              ...
              <div class="flex-1 min-w-0">
                ...
                <h4 class="font-medium text-gray-900 dark:text-white text-sm line-clamp-2 group-hover:text-brand-blue-600 dark:group-hover:text-brand-blue-400 transition-colors">
              ...
              <font-awesome-icon
                ...
                class="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-brand-blue-500 transition-colors flex-shrink-0 mt-2 rtl:rotate-180"
              />
            </NuxtLink>
          </div>
        </div>
        ...
        <div v-if="!isMinimized" class="border-t border-gray-100 dark:border-gray-700 p-3">
          <NuxtLink
            ...
            class="flex items-center justify-center gap-2 text-sm text-brand-blue-600 dark:text-brand-blue-400 hover:text-brand-blue-700 dark:hover:text-brand-blue-300 font-medium transition-colors"
            @click="close"
          >
