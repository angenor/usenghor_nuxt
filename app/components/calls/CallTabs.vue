...
const tabs = [
  { id: 'presentation', label: () => t('actualites.detail.call.tabs.presentation'), icon: 'fa-solid fa-file-lines' },
  { id: 'actualites', label: () => t('actualites.detail.call.tabs.actualites'), icon: 'fa-solid fa-newspaper' },
  { id: 'mediatheque', label: () => t('actualites.detail.call.tabs.mediatheque'), icon: 'fa-solid fa-photo-film' },
]
