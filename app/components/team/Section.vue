  ...
  >
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-md mx-auto">
          <div class="relative">
            ...
            <input
              ...
              class="w-full pl-11 pr-4 py-3 bg-gray-100 dark:bg-gray-800 border-0 rounded-full text-gray-900 dark:text-white placeholder-gray-500 focus:ring-2 focus:ring-amber-500 transition-all duration-300"
            />
            <button
              v-if="searchQuery"
              type="button"
          ...
          <div class="p-5">
            ...
            <div class="flex items-center gap-3 pt-3 border-t border-gray-100 dark:border-gray-700">
              <a
                ...
                class="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-amber-100 hover:text-amber-600 dark:hover:bg-amber-900/30 dark:hover:text-amber-400 transition-colors duration-300"
              >
      ...
      >
        ...
        <button
          type="button"
          class="inline-flex items-center gap-2 px-6 py-3 bg-amber-500 hover:bg-amber-600 text-white font-medium rounded-full transition-colors duration-300"
          @click="clearFilters"
        >
