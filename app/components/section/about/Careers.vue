      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="relative order-2 lg:order-1">
          <div class="relative rounded-2xl overflow-hidden shadow-2xl">
            <div class="aspect-[4/3] bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center">
              <font-awesome-icon icon="fa-solid fa-briefcase" class="w-16 h-16 text-gray-400 dark:text-gray-500" />
            </div>
        ...
        <div class="order-1 lg:order-2">
          <span class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium mb-6 bg-lime-100 dark:bg-lime-900/30 text-lime-700 dark:text-lime-400">
            <font-awesome-icon icon="fa-solid fa-briefcase" class="w-3.5 h-3.5 mr-2" />
            {{ t('about.preview.careers.title') }}
          </span>
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            {{ t('about.preview.careers.summary') }}
          </p>
