    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div class="relative order-2 lg:order-1">
          ...
          <div class="absolute -top-4 -right-4 w-32 h-32 rounded-full -z-10 bg-rose-500/10"></div>
        </div>

        <!-- Content -->
        <div class="order-1 lg:order-2">
          <span class="inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium mb-6 bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400">
            <font-awesome-icon icon="fa-solid fa-users" class="w-3.5 h-3.5 mr-2" />
            {{ t('about.preview.team.title') }}
          </span>
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            {{ t('about.preview.team.summary') }}
          </p>

          <NuxtLink
            :to="localePath('/a-propos/equipe')"
            class="group inline-flex items-center gap-2 px-6 py-3 text-white font-semibold rounded-full transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 bg-rose-500 hover:bg-rose-600 hover:shadow-rose-500/30"
          >
