...
const tabs = [
  { id: 'presentation', label: () => t('projets.tabs.presentation'), icon: 'fa-solid fa-file-lines' },
  { id: 'appels', label: () => t('projets.tabs.appels'), icon: 'fa-solid fa-bullhorn' },
  { id: 'actualites', label: () => t('projets.tabs.actualites'), icon: 'fa-solid fa-newspaper' },
  { id: 'partenaires', label: () => t('projets.tabs.partenaires'), icon: 'fa-solid fa-handshake' },
  { id: 'mediatheque', label: () => t('projets.tabs.mediatheque'), icon: 'fa-solid fa-photo-film' }
]
