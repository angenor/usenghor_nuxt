...
function populateForm(data: FundraiserRead) {
  ...
  form.reason_html = data.reason_html || ''
  form.reason_md = data.reason_md || ''
  form.reason_en_html = data.reason_en_html || ''
  form.reason_en_md = data.reason_en_md || ''
  form.reason_ar_html = data.reason_ar_html || ''
  form.reason_ar_md = data.reason_ar_md || ''
}
