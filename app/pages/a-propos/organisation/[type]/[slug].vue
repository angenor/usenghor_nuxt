          ...
          <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 relative tab-nav-container">
            <div class="flex flex-wrap items-center justify-center">
              <button
                ...
                :key="tab.key"
                type="button"
                class="group flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-3 sm:py-4 text-xs sm:text-sm font-medium border-b-2 transition-all duration-200"
              ...
              >
                ...
                />
                <span>{{ t(`organizationDetail.tabs.${tab.key}`) }}</span>
              </button>
            </div>
          </div>
        </nav>
