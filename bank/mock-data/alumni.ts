...
export const mockAlumni: Alumnus[] = [
  // === FEATURED ALUMNI (Success Stories) ===
  {
    ...
    first_name: 'Aminata',
    last_name: 'Diallo',
    photo: 'https://i.pravatar.cc/300?u=aminata-diallo',
  ...
  },
  {
    ...
    last_name: 'Kouassi',
    photo: 'https://i.pravatar.cc/300?u=jp-kouassi',
  ...
  },
  {
    ...
    first_name: 'Fatima',
    last_name: 'Benali',
    photo: 'https://i.pravatar.cc/300?u=fatima-benali',
  ...
  },
  {
    ...
    first_name: 'Olivier',
    last_name: 'Mbeki',
    photo: 'https://i.pravatar.cc/300?u=olivier-mbeki',
  ...
  // === AUTRES ALUMNI ===
  {
    ...
    first_name: 'Aïssatou',
    last_name: 'Barry',
    photo: 'https://i.pravatar.cc/300?u=aissatou-barry',
  ...
  },
  {
    ...
    first_name: 'Mohamed',
    last_name: 'Hassan',
    photo: 'https://i.pravatar.cc/300?u=mohamed-hassan',
  ...
  },
  {
    ...
    last_name: 'Fotso',
    photo: 'https://i.pravatar.cc/300?u=mc-fotso',
    graduation_year: 2019,
    promotion: 'Promo Césaire 2019',
    department_id: 'dept-culture',
    formation_type: 'Master',
  ...
  },
  {
    ...
    first_name: 'Ibrahima',
    last_name: 'Sow',
    photo: 'https://i.pravatar.cc/300?u=ibrahima-sow',
  ...
  },
  {
    ...
    first_name: 'Nadia',
    last_name: 'Ouédraogo',
    photo: 'https://i.pravatar.cc/300?u=nadia-ouedraogo',
    graduation_year: 2017,
    promotion: 'Promo Senghor 2017',
    department_id: 'dept-sante',
    formation_type: 'Doctorat',
  ...
  },
  {
    ...
    first_name: 'Patrice',
    last_name: 'Ndongo',
    photo: 'https://i.pravatar.cc/300?u=patrice-ndongo',
    graduation_year: 2018,
    promotion: 'Promo Diouf 2018',
    department_id: 'dept-management',
    formation_type: 'Master',
  ...
  },
  {
    ...
    first_name: 'Salimata',
    last_name: 'Traoré',
    photo: 'https://i.pravatar.cc/300?u=salimata-traore',
  ...
  },
  {
    ...
    first_name: 'Youssef',
    last_name: 'El Amrani',
    photo: 'https://i.pravatar.cc/300?u=youssef-amrani',
    graduation_year: 2020,
    promotion: 'Promo Cheikh Anta Diop 2020',
    department_id: 'dept-environnement',
    formation_type: 'Master',
  ...
  },
  {
    ...
    first_name: 'Grâce',
    last_name: 'Kouamé',
    photo: 'https://i.pravatar.cc/300?u=grace-kouame',
    graduation_year: 2016,
    promotion: 'Promo Hampaté Bâ 2016',
    department_id: 'dept-sante',
    formation_type: 'Master',
  ...
  },
  {
    ...
    last_name: 'Touré',
    photo: 'https://i.pravatar.cc/300?u=ak-toure',
    graduation_year: 2015,
    promotion: 'Promo Mandela 2015',
    department_id: 'dept-management',
    formation_type: 'Doctorat',
  ...
  },
  {
    ...
    first_name: 'Leila',
    last_name: 'Mahmoud',
    photo: 'https://i.pravatar.cc/300?u=leila-mahmoud',
  ...
  },
  {
    ...
    first_name: 'Éric',
    last_name: 'Mpoyi',
    photo: 'https://i.pravatar.cc/300?u=eric-mpoyi',
    graduation_year: 2019,
    promotion: 'Promo Césaire 2019',
    department_id: 'dept-environnement',
    formation_type: 'Master',
  ...
  },
  {
    ...
    first_name: 'Mariama',
    last_name: 'Camara',
    photo: 'https://i.pravatar.cc/300?u=mariama-camara',
    graduation_year: 2021,
    promotion: 'Promo Wangari Maathai 2021',
    department_id: 'dept-sante',
    formation_type: 'Master',
  ...
  },
  {
    ...
    first_name: 'Serge',
    last_name: 'Habimana',
    photo: 'https://i.pravatar.cc/300?u=serge-habimana',
    graduation_year: 2022,
    promotion: 'Promo Miriam Makeba 2022',
    department_id: 'dept-management',
    formation_type: 'Master',
