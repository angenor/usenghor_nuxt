...
export const mockCampusEvents: CampusEvent[] = [
  // Siège - Alexandrie - Événements à venir
  {
    id: 'event-siege-1',
    campus_id: 'siege',
  ...
  },
  {
    id: 'event-siege-3',
    campus_id: 'siege',
    title_fr: 'Cérémonie de remise des diplômes 2025',
    title_en: 'Graduation Ceremony 2025',
    title_ar: 'حفل تخرج 2025',
    date: '2026-02-28',
  ...
  },
  {
    id: 'event-siege-8',
    campus_id: 'siege',
    title_fr: 'Cérémonie d\'ouverture de l\'année académique 2026-2027',
    title_en: 'Opening Ceremony Academic Year 2026-2027',
    title_ar: 'حفل افتتاح العام الدراسي 2026-2027',
    date: '2026-09-15',
    location_fr: 'Amphithéâtre principal, Université Senghor',
    location_en: 'Main Amphitheater, Senghor University',
  ...
  {
    id: 'event-siege-past-4',
    campus_id: 'siege',
    title_fr: 'Table ronde : Développement durable et ODD en Afrique',
    title_en: 'Roundtable: Sustainable Development and SDGs in Africa',
    title_ar: 'طاولة مستديرة: التنمية المستدامة وأهداف التنمية المستدامة في أفريقيا',
    date: '2026-01-08',
    location_fr: 'Salle de conférence, Bâtiment A',
    location_en: 'Conference Room, Building A',
  ...
  {
    id: 'event-siege-past-5',
    campus_id: 'siege',
    title_fr: 'Cérémonie de rentrée académique 2025-2026',
